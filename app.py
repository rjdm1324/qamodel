...
tokenizer2 = AutoTokenizer.from_pretrained("seongju/klue-mrc-koelectra-base")
...
question_answer2 = pipeline(
    "question-answering",
    model="seongju/klue-mrc-koelectra-base",
...
def make_answer(input):
    try:
        ...
        if input['lan']=="en":
            ...
            result = question_answer2(question=input['question'], context=input['context'])
            return result
    except Exception as e:
...
def generate():
    ...
    try:
        ...
        sentence3 = request.form['lan']
        args.append(sentence)
        args.append(sentence2)
        args.append(sentence3)
    except Exception as e:
        return jsonify({'message': 'Invalid request'}), 500

    req = {'input': {'question': args[0],'context':args[1],'lan':args[2]}}
